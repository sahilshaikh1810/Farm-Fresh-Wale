                ...
                <div class="modal-body">
                    ...
                    <div class="tab-pane active" id="register" role="tabpanel">
                            ...
                            <form method="post" action="#" onsubmit="return userregister();">
                                ...
                                <input class="form-control"  type="email" name="email"  id="uemail" placeholder="Email">                                      
                                </fieldset>
                                                
                                <fieldset class="form-group">
                                <label>Enter Mobile (Mandatory)</label>
                                <input class="form-control" type="text" name="mobile" required id="umobile" pattern="[1-9]{1}[0-9]{9}" placeholder="Mobile">                                    
                                </fieldset>
                                                
                                <fieldset class="form-group">
                                <label>Enter Password </label>
                                <input class="form-control"  type="password" name="password" required id="unew_password" Placeholder="Password">                                   
                                </fieldset>
                                                
                                 <fieldset class="form-group">
                                <label>Enter Repeat Password </label>
                                <input class="form-control"   type="password" name="passwordRepeat" required id="upassword_repeat" Placeholder="Confirm password">                     
                                </fieldset>    
                                                
                                   
                                <div id="referral">
                                <a href="javascript:void(0)" onclick="showReferralCodeField();">Have a referral Code?</a></div>
                                ...
                                <fieldset class="form-group">
                                <input type="submit" class="btn btn-lg btn-secondary btn-block" type="submit" name="signupSubmit" value="Register">                               
                                </fieldset>
                                </form>
